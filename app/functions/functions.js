...
module.exports = {
    ...
    generateUploadSignedUrl: function(params) {
        let { region, bucket, path, expires = 4 * 60, acl = 'private', contentType = 'application/octet-stream', accessKeyId = config.awsAccessKey, secretAccessKey = config.awsSecretKey } = params
